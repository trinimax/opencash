...
class CI_Email {
	...
	var	$smtp_host		= "dime28.dizinc.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "cashctrl+dimsatec.com";		// SMTP Username
	var	$smtp_pass		= "bQ89cUiWT6Xa";		// SMTP Password
	...
	var $alt_message	= 'Por favor active la compatibilidad HTML para visualizar este correo.';		// Alternative message for HTML emails
