...
<html>
    <head>
        ...
        <title>Ventas pendientes de cobro - <?php print NOMBRE_APP; ?></title>
        ...
        <div id="contenido">
            ...
            <div id="cuerpo">
            	<table width="950" align="center" cellpadding="0" cellspacing="0" id="titulo">
            		<tr>
            			<td align="left"><h1>Ventas pendientes de cobro</h1></td>
            	...
            	<table align="center" cellpadding="5" cellspacing="0" id="grid" class="tablesorter" style="width:950px;">
            		<thead>
            			<tr>
            				<th width="25">No</th>
            				<th width="125">Tipo de venta</th>
            				<th width="75">Mesa</th>
            				<th width="75">Silla</th>
            		...
            		<tbody>
            			...
            			<?php else: ?>
            				...
            				<tr class="row<?php print $i%2==0 ? ' odd' : ''; ?>">
            					...
            					<td align="center"><?php print $ventas[$i]->mesa;?></td>
            					...
            					<td align="center">
            						<a href="<?php print base_url();?>ventas/registrar/<?php print $ventas[$i]->folio;?>">
            						<img border="0" src="<?php print base_url();?>resources/images/icon_dinero.png" alt="Cobrar" />
            						</a>
            					</td>
            				</tr>
            				<?php endfor; ?>
