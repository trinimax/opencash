        				...
        				if(r) {
        					$.ajax({
								...
								data: {
									...
									"vale" : $("#txtVales").val(),
									"usuario" : <?php print $usuario_cajero->id_usuario; ?>
								},
								success: function(id){
        ...
        <div id="contenido">
            ...
            <div id="cuerpo">
            	...
            	<table width="400" align="center" cellpadding="10" cellspacing="0" class="tabla">
            		<thead>
            			<tr>
            				<td colspan="4" align="center">Corte de caja actual</td>
            			</tr>
            		</thead>
            		<tbody>
            			<tr>
            			...
            			<tr>
            				...
            				<td>$ <input type="text" name="txtEfectivo" id="txtEfectivo" value="0" class="moneda" size="10" maxlength="10" /></td>
            			</tr>
            			<tr>
            				<td align="right">
            			...
            			<tr>
            				...
            				<td>$ <input type="text" name="txtTarjeta" id="txtTarjeta" value="0" class="moneda" size="10" maxlength="10" /></td>
            			</tr>
            			<tr>
            				<td align="right">
            			...
            			<tr>
            				...
            				<td>$ <input type="text" name="txtPropinas" id="txtPropinas" value="0" class="moneda" size="10" maxlength="10" /></td>
            			</tr>
            			<tr>
            				<td align="right">
            			...
            			<tr>
            				...
            				<td>$ <input type="text" name="txtVales" id="txtVales" value="0" class="moneda" size="10" maxlength="10" /></td>
            			</tr>
            			<tr>
            				<td align="right">
            	...
            	<div style="text-align:center;">
            		<button type="button" name="btnRegresar" id="btnRegresar">
            			<span class="icon-regresar">&nbsp;</span> Regresar
            		</button>
            	</div>
            	<script type="text/javascript">
            		$(function(){
